...
def get_Data():
    X = []
    Y = []
    dataFile = "/home/myc/projectpy/cnnTensorflowNew/data/CaricaPapaya/caricapapaya_label_0_100.txt"
...
def cross_validate(X_0, Y_0, X_1, Y_1, Z_1, epochs, class_num, feature_num, collection_name, split_size=5):
    results = []
    hmaps = []
    cvscores = dict()
    tprs = dict()
    ...
    for (fold, (train_0, test_0)), (train_1, test_1) in zip(enumerate(kfold.split(X_0, Y_0)),
        ...
        x_train_1 = X_1[train_1]
        ky_train_1 = Y_1[train_1]
        z_train_1 = Z_1[train_1]
        ...
        #ros = SMOTEENN(ratio={0: 80, 1: 80}, n_jobs=6)
...
results, checkpoints = cross_validate(X_0, Y_0, X_1, Y_1, Z_1, epochs, num_classes, num_features,
